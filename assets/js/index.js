...
/**
 * fetch all genres eg: [{id: 28, name: "Action"}, {id: 12, name: "Adventure"}, ...] 
 * the change genre formate to {28: "Action", 12: "Adventure", ...}
 */
...
const genreList = {
  asString(genreIdList) {
    ...
    for (const genreId of genreIdList) {
      if (this[genreId]) {
        newGenreIdList.push(this[genreId]);
      }
    }
...
function heroBanner({ results: moviesList }) {
